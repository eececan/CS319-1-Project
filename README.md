...
Admin: Full control over the system, able to manage users, events, and system configurations.
Vice Admin (Öğretim Yardımcısı): Assists with admin tasks.
Coordinator (Koordinatör): Manages tours and assigns guides.
Advisor (Danışman): Provides guidance for prospective students during tours.
Guide: Leads tours for prospective students and provides information about the university.
Prospective Student: The user visiting the university for a tour.
School Counselor: Coordinates students' visit schedules from specific high schools.
